...
# Fresh decompile
subprocess.run(['java', '-jar', 'apktool.jar', 'd', '-f', 'kodi.apk', '-o', 'decompiled_kodi_new'], 
               capture_output=True)
...
# Copy using only v0-v3. Carefully traced register usage:
# v0 = dest File
# v1 = src File  
# v2 = FileInputStream
# v3 = FileOutputStream (later reused for boolean results)
new = '''    iget-object v0, p0, Lorg/xbmc/kodi/Splash$FillCache;->mSplash:Lorg/xbmc/kodi/Splash;
    ...
    const-string v2, "/.kodi/userdata/Database/Addons33.db"
    ...
    iget-object v3, p0, Lorg/xbmc/kodi/Splash$FillCache;->mSplash:Lorg/xbmc/kodi/Splash;

    invoke-virtual {v3}, Lorg/xbmc/kodi/Splash;->getFilesDir()Ljava/io/File;
...
print("Patched with minimal registers (v0-v4)")

# Now try to build
result = subprocess.run(['java', '-jar', 'apktool.jar', 'b', 'decompiled_kodi_new', '-o', 'kodi_custom_unsigned.apk'],
